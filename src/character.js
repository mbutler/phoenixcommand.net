 ...
 */
 ...
 export function displayGear(character) {
     ...
     $('#change-gear').click(e => {
         ...
         let speed = pf.movementSpeed(character.strength, character.agility, encumbrance)
         let capi = pf.combatActionsPerImpulse(character.strength, character.agility, character.intelligence, character.skillLevel, encumbrance)
